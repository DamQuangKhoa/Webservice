...
<body>
 <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
              ...
              <a href="" class="site_title"><i class="fa fa-paw"></i> <span>Environment</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="BinhLuan/BinhLuan.jsp"><i class="fa fa-edit"></i> Quản lí quà tặng</a>
                    <ul class="nav child_menu">
                    </ul>
                  </li>
                  <li><a href="HoiDapAdmin.jsp"><i class="fa fa-edit"></i> Quản lí thông tin kẹt xe  </a>
                  </li>
                   <li><a><i class="fa fa-table"></i> Quản lí thông tin ô nhiễm <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
